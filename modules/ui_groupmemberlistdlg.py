...
################################################################################
## Form generated from reading UI file 'groupmemberlistdlgCFWpYr.ui'
##
...
"border-bottom: 1px solid #3498db;")
        self.dialog_treeview_groupmemberlist = QTreeView(Dialog)
        self.dialog_treeview_groupmemberlist.setObjectName(u"dialog_treeview_groupmemberlist")
        self.dialog_treeview_groupmemberlist.setGeometry(QRect(-2, 52, 641, 371))
        self.dialog_treeview_groupmemberlist.setStyleSheet(u"background-color: rgb(31, 35, 41);\n"
...
"")
        ...
        self.dialog_treeview_groupmemberlist.raise_()
